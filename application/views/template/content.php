       ...
       <div class="content-area">
           ...
           <div class="content-area-inner">
               ...
               <section id="intro">
                   ...
                   <div class="container-mid">
                       ...
                       <div class="animation-container animation-fade-left" data-animation-delay="300" >
                           ...
                           <p class="subline" >
                               Saya sedang belajar untuk menjadi seorang Web Developer untuk mencari Skill dan Bakat saya.
                               Saya pernah mengembangkan Website Sekolah, Website Desa, hingga saat ini saya sedang merancang Iot untuk Tugas Akhir Kuliah. </p>
                           
                           <p class="subline">
                               Pada saat ini keseharian saya sedang menempuh kuliah D3 Teknik Informatika, 
                               dan diluar kampus saya olahraga seperti Lari dan Bermain Bola Volly. 
                           </p>
               ...
               <section id="about">
                   ...
                   <p class="scroll-animated-from-right"> Saya dapat mengerjakan beberapa pekerjaan dengan berbagai bidang seperti Product Design, Web Design, Animation, Editing Image, & photography </p>
               ...
               <section id="service">
                   ...
                   <ul class="services-list">
                       ...
                       <li class="scroll-animated-from-right"><i class="fa fa-child" aria-hidden="true"></i>Animation</li>
                       <li class="scroll-animated-from-right"><i class="fa fa-file-photo-o" aria-hidden="true"></i>Editing Image</li>
